...
class EntryFilterView(views.APIView):
    ...
    def get(self, request):
        ...
        EntryDetails_sel = models.EntryDetails.objects.filter(UserCode=request.GET.get('UserCode'), MedicalCenterCode=request.GET.get('MedicalCenterCode'), EntryDate__range=[start_date, end_date])
